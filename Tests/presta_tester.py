...
class PrestaShopTester:
    ...
    def add_10_products(self):
        product_xpaths = [
            "//a[@href=\"https://localhost:18430/index.php?id_product=126&rewrite=dres&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=334&rewrite=inne-akcesoria&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=22&rewrite=wkladki-do-butow&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=172&rewrite=cs-5460-duo-pack-hento-toto-editon---higiena-jamy-ustnej&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=215&rewrite=dol-od-bikini&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=210&rewrite=365---legginsy&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=68&rewrite=botki&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=224&rewrite=prochowiec&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=359&rewrite=set---pierscionek&controller=product\"]",
            "//a[@href=\"https://localhost:18430/index.php?id_product=334&rewrite=inne-akcesoria&controller=product\"]"
        ]
...
# Użycie klasy
tester = PrestaShopTester("https://localhost:18430")
