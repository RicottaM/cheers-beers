...
use Sendinblue\Hooks\ActionProductsHook;
use Sendinblue\Hooks\ActionCategoryHook;
use Sendinblue\Hooks\ActionOrderEditHook;
...
class HooksFactory
{
    ...
    /**
     * @return ActionCategoryHook
     */
    public static function getActionCategoryHook()
    {
        return new ActionCategoryHook();
    }

    /**
     * @return ActionProductsHook
     */
    public static function getActionProductsHook()
    {
        return new ActionProductsHook();
    }

    /**
     * @return ActionOrderEditHook
     */
    public static function getActionOrderEditHook()
    {
        return new ActionOrderEditHook();
    }
}
