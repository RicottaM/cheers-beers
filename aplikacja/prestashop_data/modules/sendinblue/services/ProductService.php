...
class ProductService
{
    ...
    public function getProductsForFullSync($offset, $itemsPerPage)
    {
        ...
        foreach ($all_products as $key => $product) {
            ...
            $products[$key]['price'] = strval(\ProductCore::getPriceStatic(
                $product['id_product'],
            ));
            ...
            $products[$key]['status'] = strval($product['state']);
            $products[$key]['type'] = $product['product_type'];
            $products[$key]['description'] = $product['description'];
            $products[$key]['short_description'] = $product['description_short'];
            ...
            $products[$key]['stock_quantity'] = \ProductCore::getQuantity($product['id_product']);
