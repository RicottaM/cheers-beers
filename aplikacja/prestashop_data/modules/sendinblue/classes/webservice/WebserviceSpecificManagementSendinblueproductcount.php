...
class WebserviceSpecificManagementSendinblueproductcount extends \WebserviceSpecificManagementSendinblueAbstract
{
    public function manage()
    {
        try {
            $categoryService = new ProductService();
            $this->response = [ 'count' => $categoryService->getTotalProductCount()];
        } catch (\Exception $e) {
            $this->response = [
                self::SUCCESS => false,
