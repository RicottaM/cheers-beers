...
class WebserviceSpecificManagementSendinblueordercount extends \WebserviceSpecificManagementSendinblueAbstract
{
    public function manage()
    {
        try {
            $orderService = new OrderService();
            $this->response = [ 'count' => $orderService->getTotalOrderCount()];
        } catch (\Exception $e) {
            $this->response = [
                self::SUCCESS => false,
