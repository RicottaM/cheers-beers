...
class OrderSyncJob implements JobInterface
{
    use ShopIdTrait;
    ...
    public function execute($idStore = null)
    {
        ...
        if (isset($this->method) && $this->method) {
            ...
            $command->setMethod(
                $command->getOrderExists($this->orderId)
    ...
    public function __construct($arrayPropertiesJson = null)
    {
        if($arrayPropertiesJson){
            ...
            $this->orderId = $arrayProperties->orderId;
